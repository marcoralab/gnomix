...
The following filters will be used for LAI assignment:

*  Only samples passing the initial superpopulation check (NAs removed)
*  No Oceanic samples
*  The maximum ADMIXTURE superpopulation asssignment must match the gnomAD assignment
*  The proportion of the maximimum ADMIXTURE superpopulation must exceed a certain number.
...
out_admix |>
  filter_output(0.8) |>
  plot_admix(by = superpops, poplabel = F) +
...
This is a map of populations with standard filters and only individuals with at least 80% their primary population

```{r map_filt, echo=FALSE, fig.width = 14, fig.height = 7.5, warning = FALSE, cache = TRUE}
world <- ne_countries(scale = "medium", returnclass = "sf")
